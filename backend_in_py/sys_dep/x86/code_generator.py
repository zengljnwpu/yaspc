...
class CodeGenerator ():
    ...
    #
    #     if (self._options.is_verbose_asm()):
    ...
    #             regs.append(Register (c, self._natural_type))
    ...
    #     if var._mem_ref():
    #         a = Register (dest.for_type (self._natural_type))
    ...
    #
    # def __si (self):
    #     return Register (RegisterClass.SI, self._natural_type)
    # def __di (self):
    #     return Register (RegisterClass.DI, self._natural_type)
    # def __bp (self):
    #     return Register (RegisterClass.BP, self._natural_type)
    # def __sp (self):
    #     return Register (RegisterClass.SP, self._natural_type)
