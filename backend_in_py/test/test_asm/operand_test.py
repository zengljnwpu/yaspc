...
class TestIndirect(unittest.TestCase):
    def setUp(self):
        self.a = IndirectMemoryReference (20, Register())

    def test_init(self):
        self.assertIsInstance(IndirectMemoryReference(20, Register()), IndirectMemoryReference)

    def test_reloc(self):
        self.assertIsInstance( IndirectMemoryReference.reloca_table (offset = 20, base = Register()), IndirectMemoryReference)

    def test_fix_offset (self):
        with self.assertRaises(Exception):
            self.a.fix_offset(20)
        a = IndirectMemoryReference (20, Register(), False)
        a.fix_offset(30)
    ...
    def test_collect(self):
        a = IndirectMemoryReference (0, Register())
        b = Statistics()
    ...
    def test_to_source (self):
        ...
        a = IndirectMemoryReference(20, Register())
        self.assertEqual(a.to_source(dummy), "20()")

    def test_compare(self):
        self.assertEqual(self.a.cmp (DirectMemoryReference(20)), -1)
        self.assertEqual(self.a.cmp (IndirectMemoryReference(20, Register())), 0)
...
class TestDirect(unittest.TestCase):
    ...
    def test_compare(self):
        ...
        self.assertEqual(self.a.cmp (IndirectMemoryReference(20, Register())), 1)
